                      ...
                      <div class="row">
                        <div class="input-group-prepend col-12">
                          ...
                          <select class="form-control kt-selectpicker" data-size="7" data-live-search="true">
                            ...
                            <option value="emp_2">  موظف 2 </option>
                          </select>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="card-header" id="accordion_project_1">
                          <div class="card-title brand_bg" data-toggle="collapse" data-target="#collapse_project_1" aria-expanded="true" aria-controls="collapse_project_1">
                            <div class="info_box d-flex flex-column">
                              <span class="mx-2 kt-font-boldest"> مشروع 1 </span>
                              <span class="mx-2 kt-font-boldest kt-label-font-color-2"> مجموعة مهام 1 , موظف 1</span>
                            </div>                        
                          ...
                          <div class="card-body p-4">
                            <div class="kt-notification-v2">
                              <span class="kt-notification-v2__item border rounded d-flex alig-items-center justify-content-center">
                                <div class="btn_box d-flex flex-column mx-3">
                                  <span class="my-2"> <span class="kt-font-success kt-font-boldest"> البداية: </span> 2021 - 4 - 10 </span>
                                  <span class="my-2"> <span class="kt-font-danger kt-font-boldest"> الانتهاء: </span> 2021 - 4 - 15 </span>
                                </div>
                              </span>
                              ...
                              <span class="kt-notification-v2__item border-bottom data">
                                <div class="kt-notification-v2">
                                  <label class="kt-checkbox kt-checkbox--info">
                                    <input type="checkbox" class="user_checkbox" checked>
                                    <span></span>
                                  </label>
                                </div>
